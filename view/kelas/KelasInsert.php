...
<head>
    ...
    <script type="text/javascript">
		...
		document.forms["fEdu"].action="?page=KelasAction&action=insert";
...
<form id="fEdu" name="fEdu" method="post" enctype="multipart/form-data">
    ...
    <tr>
      ...
      <td>:</td>
      <td><input name="txtNamaKelas" type="text" id="txtNamaKelas" maxlength="100" size="40"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>Keterangan</td>
      <td>:</td>
      <td><textarea name="txtKeterangan" id="txtKeterangan" rows="4" cols="30"></textarea></td>
    </tr>
