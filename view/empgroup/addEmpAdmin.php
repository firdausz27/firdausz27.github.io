...
$qryCheck="select * from empgroup_admin where empgroup_id=$kode";
...
<script type="text/javascript">
    ...
    function kirim(){
        document.forms["fAll"].action="?page=addEmpAdmin";
    ...
    function validasi(){
        ...
        if(cboJadual==''){
            ...
            document.forms["fAllKirim"].action="?page=AddEmpAdminAction";
