...
<html>
    ...
    <body style="margin-left: 0px; margin-top: 0px;">
        <form name="fGroup" method="post" action="?page=EmpGroupAction&action=insert">
        <table width="100%" border="0" cellspacing="3" cellpadding="3" class="table-shadow" >    
            <tr>
                <td colspan="4" align="left" class="title-form"><img src="./images/application_side_list.png" ">&nbsp;<b>Input Group Personal</b></td>
            </tr>
             <tr>
                 <td colspan="4">&nbsp;</td>
            </tr>
