...
$qryCheck="select * from empgroup_data where empgroup_id=$kode";
...
<script type="text/javascript">
    ...
    function kirim(){
        document.forms["fAll"].action="?page=AddEmpPersonal";
    ...
    function validasi(){
        ...
        if(cboJadual==''){
            ...
            document.forms["fAllKirim"].action="?page=AddEmpPersonalAction";
