...
<html>
        ...
        <script>
            function validasi(){
                ...
                if(field==="blank"){
                    ...
                    document.forms["fGroup"].action="?page=EmpGroupForm";
    ...
    <form name="fGroup" method="post">
        <table width="100%" border="0" cellspacing="3" cellpadding="3" class="table-shadow">    
            <tr>
                <td width="839" colspan="9" align="left" class="title-form"><img src="./images/application_side_list.png" ">&nbsp;<b>Setting | Group Personal </b></td>
            </tr>
            <tr>
            	<td>Cari 
            ...
            <tr>
              <td colspan="9"><a href="?page=EmpGroupInsert">Tambah Group</a></td>
            </tr>
            <tr>
                <td colspan="2">
                  ...
                  <tr <?php if(($nomor % 2) ==0){ echo 'style="background:#E2EBED;"';}else{echo 'style="background:#F0F0F0;"';}?>>
                    ...
                    <td><a href="?page=EmpGroupUpdate&Kode=<?php echo $id;?>"><?PHP echo $value->getNamaGroup();?></a></td>
