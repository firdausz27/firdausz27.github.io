...
$kode=buatKodeYear("keuangan_pemasukan");
$tanggl= date('m/d/Y');
...
<script type="text/javascript">
    ...
    function valid(mode){
            ...
            if(txtId==""){
                ...
                for(i=1;i<=rowCount;i++){
                        if(document.getElementById("txtKode_"+i) && document.getElementById("txtJumlah_"+i)){
                            var kode=document.getElementById("txtKode_"+i).value;
                            var jumlah=document.getElementById("txtJumlah_"+i).value;
                                if(kode==""){
                                    alert("Penyetor belum dipilih !");
                                    document.getElementById("txtKode_"+i).focus();
                                    return false;
                ...
                if(hasil==true){
                    if(mode=='insert'){
                        document.forms["form1"].action="?page=KeuanganPemasukanAction&action=insert";
   ...
   function myCreateFunction() {
        ...
        cell2.innerHTML = "<input type='text' name='txtKode_"+rowCount+"' id='txtKode_"+rowCount+"' size='15' readonly=''/><input type='text' name='txtNama_"+rowCount+"' id='txtNama_"+rowCount+"' size='25'/><input type='button' name='add_"+rowCount+"' id='add_"+rowCount+"' value='Add' onclick='klik("+rowCount+")'/>";
   ...
   function klik(no){
       document.getElementById("add_"+no).addEventListener("click", popupwindow("./view/keuangan_pemasukan/SearchPersonal.php?no="+no,"Cari Personal Data",950,600));
   }
...
<form id="form1" name="form1" method="post" action="">
  <table  width="100%" border="0" cellspacing="1" cellpadding="5" 
    ...
    <tr>
        <td colspan="5" align="left" style="background: url(./images/headercontent2.jpg); font-size: 15px; color: #fff;"><!--<img src="./images/form_add.png">-->&nbsp;<b>Keunagan | Pemasukan</b></td>
    </tr>
    <tr>
      <td width="50">&nbsp;</td>
      <td width="176">&nbsp;</td>
      ...
      <td colspan="3">
          <table width="100%" border="0" cellspacing="1" cellpadding="2" class="table-list" id="tDetail">
            <tr>
              ...
              <th width="42%" scope="col"><div align="left">Penyetor</div></th>
            ...
            <tr>
                <td>1</td>
                <td><input type="text" name="txtKode_1" id="txtKode_1" size="15" readonly=""/><input type="text" name="txtNama_1" id="txtNama_1" size="25"/><input type="button" name="txtEmp_1" value="Add" onclick='javascript:popupwindow("./view/keuangan_pemasukan/SearchPersonal.php?no=1","Cari Personal Data",950,600);'/></td>
