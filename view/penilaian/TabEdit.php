...
<div id="container">
    <ul id="navtab">
        <li><a href="#tab1" <?php if($mode=="1") echo 'class="active"';?>>Input Penilaian</a></li>
        <!--<li><a href="#tab2" <?php// if($mode=="2") echo 'class="active"';?>>Tambah Lulusan</a></li>-->
    </ul>
    <div class="clear"></div>
    <div id="konten">
    	<div style="display: none;" id="tab1" class="tab_konten">
            <?php include_once './view/penilaian/Penilaian.php';?>
        </div>
		
        <!--<div style="display: none;" id="tab2" class="tab_konten">
            <?php //include_once './view/penilaian/Penilaian_1.php';?>
        </div>-->
