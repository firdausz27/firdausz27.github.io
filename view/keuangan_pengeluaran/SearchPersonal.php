    ...
    <head>
        ...
        <script>
            function changeparent(doc,doc2){
                    var input1=doc;
                    var input2=doc2;
                    var no=<?php echo $urutan;?>;
                    window.opener.document.getElementById('txtKode_'+no).value=input1;
                    window.opener.document.getElementById('txtNama_'+no).value=input2;
                    window.close();
            }
            ...
            function validasi(){
                ...
                if(field==="blank"){
                    ...
                    document.forms["fPersonal"].action="?no=<?php echo $urutan;?>";
            ...
            function kirim(){
                document.forms["fPersonal"].action="?./view/keuangan_pemasukan/SearchPersonal.php?no=<?php echo $urutan;?>";
                document.forms["fPersonal"].submit();
                return true;
            }
        </script>
