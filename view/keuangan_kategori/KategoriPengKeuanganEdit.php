            ...
            if(txtKode===""){
                ...
                if(mode==="delete"){
                    if(confirm('Apakah anda yakin mau menghapus ?')){
                        document.forms["fPersonal"].action="?page=KeuanganPengKategoriAction&action=delete";
                        document.forms["fPersonal"].submit();
                        return true;
                    }
                }else if(mode==="update"){
                    document.forms["fPersonal"].action="?page=KeuanganPengKategoriAction&action=update";
                    document.forms["fPersonal"].submit();
                    return true;
                }
            }
