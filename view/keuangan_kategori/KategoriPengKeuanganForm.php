...
$kategoriDa=new KeuanganPengKategoriDao();
...
$select='';
$text='';
if(isset($_POST['cboCari']) && isset($_POST['txtCari'])){
...
<html>
        ...
        <script>
            function validasi(){
                ...
                if(field==="blank"){
                    ...
                    document.forms["fKategori"].action="?page=TabEditKategori&mode=2";
    ...
    <form name="fKategori" method="post">
        <table width="100%" border="0" cellspacing="3" cellpadding="3" class="table-shadow">    
            <tr>
                <td width="839" colspan="9" align="left" class="title-form"><img src="./images/application_side_list.png" ">&nbsp;<b>Keuangan | Kategori Pengeluaran </b></td>
            </tr>
            <tr>
            	<td>Cari 
            ...
            <tr>
              <td colspan="9"><a href="?page=KategoriPengKeuangan">Tambah Kategori</a></td>
            </tr>
            <tr>
                <td colspan="2">
                  ...
                  <tr <?php if(($nomor % 2) ==0){ echo 'style="background:#E2EBED;"';}else{echo 'style="background:#F0F0F0;"';}?>>
                    ...
                    <td><a href="?page=KategoriPengKeuanganEdit&Kode=<?php echo $id;?>"><?PHP echo $value->getKode();?></a></td>
      ...
      <tr>
          ...
          <td align="right"> Halaman Ke :
              <?php
                for($h=1;$h<=$max;$h++){
                    $list[$h]=$row*$h-$row;
                    echo "<a href='?page=KategoriPengKeuanganForm&hal=$list[$h]'>$h</a>";
                }              
               ?>
          </td>
      </tr>
