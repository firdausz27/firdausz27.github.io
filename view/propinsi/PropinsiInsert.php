...
<body>
<form id="fPropinsi" name="fPropinsi" method="post"  action="?page=PropinsiAction&action=insert">
    <table width="62%" border="0" cellspacing="1" cellpadding="5" class="table-shadow">
    <tr>
        <td colspan="4" align="left" class="title-form"><img src="./images/form_add.png">&nbsp;<b>Setting | Tabel Referesi | Input Propinsi</b></td>
    </tr>
    <tr>
      <td width="70">&nbsp;</td>
      <td width="122">&nbsp;</td>
