...
/*if(isset($_GET['Kode'])){
    ...
    $pendidikan = $pendidikanDao->getPendidikan($_GET['Kode']);
    $dataKode=$pendidikan->getEducationId();
    $kode=$pendidikan->getPersonalId();
}*/
?>
<! DOCTYPE html>
<html>
<head>
    <script>    
		...
		document.forms["fEdu"].action="?page=EduAction&action=insert";
...
<form id="fEdu" name="fEdu" method="post" enctype="multipart/form-data">
    ...
    <tr>
        <td colspan="4" align="left" style="background: url(./images/headercontent2.jpg); font-size: 13px; color: #fff;"><!--<img src="./images/form_add.png">-->&nbsp;<b>Mster | Input Pendidikan</b></td>
    </tr>
    <tr>
      <td width="58">&nbsp;</td>
      <td width="133">&nbsp;</td>
    ...
    <tr>
      ...
      <td>:</td>
      <td>
          <input name="txtInstitusi" type="text" id="txtInstitusi" size="50" maxlength="50" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      ...
      <td>:</td>
      <td>
          <input name="txtNilaiRata" type="text" id="txtNilaiRata" size="50" maxlength="50" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      ...
      <td>
          <?php 
          $dateIjasah=  date("");
          echo form_tanggal("txtTglIjazah",$dateIjasah);
          ?>
          <!--<input type="text" id="txtTglIjazah" name="txtTglIjazah" size="20" maxlength="20" />-->&nbsp; format ( mm/dd/yyyy )</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>No Ijazah</td>
      <td>:</td>
      <td>
          <input name="txtNoIjazah" type="text" id="txtNoIjazah" size="20" maxlength="15" />
          &nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td>Propinsi</td>
      <td>:</td>
      <td><input name="txtPropinsi" type="text" id="txtPropinsi" size="50" maxlength="100" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      ...
      <td>:</td>
      <td>
          <input name="txtNegara" type="text" id="txtNegara" size="50" maxlength="100" /></td>
    </tr>
