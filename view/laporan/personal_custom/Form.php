...
<script type="text/javascript">
    ...
    function kirim(){
        document.forms["fAll"].action="?page=CustomForm";
    ...
    function validasi(){
        ...
        if(cboJadual==''){
            ...
            document.forms["fAllKirim"].action="./view/laporan/personal_custom/AllPersonal.php"
...
<body>
    ...
    <!--<tr>-->
        <tr>
           <td colspan="1" align="left" style="background: url(./images/headercontent2.jpg); font-size: 13px; color: #fff;"><!--<img src="./images/form_add.png">-->&nbsp;<b>Laporan | Data Custom </b></td>
        </tr>
        <tr>
            <td>
                         ...
                         <table width="100%" border="0" cellspacing="1" cellpadding="5" >
                             <tr>
                                ...
                                <td >
                                     ...
                                     <legend>Data Yang Tampil</legend>
                                        <table>
                                            <tr>
                                                <td><input type="checkbox" name="checkKategori" value="1"/>Kategori Santri</td>
                                                <td><input type="checkbox" name="checkKelamin" value="1" />Kelamin</td>
                                                <td><input type="checkbox" name="checkTTL" value="1" />Tempat Tgl Lahir</td>
                                            </tr>
                                            <tr>
                                                <td><input type="checkbox" name="checkTelepon" value="1" />Telepon</td>
                                                <td><input type="checkbox" name="checkAlamat" value="1" />Alamat</td>
                                                <td><input type="checkbox" name="checkKota" value="1" />Kota</td>
                                            </tr>
                                            <tr>
                                                <td><input type="checkbox" name="checkPropinsi" value="1" />Propinsi</td>
                                                <td><input type="checkbox" name="checkNegara" value="1" />Negara</td>
                                                <td><input type="checkbox" name="checkTglGabung" value="1" />Tgl Bergabung</td>
                                            </tr>
                                        </table>
                                     </fieldset>
                                </td>
