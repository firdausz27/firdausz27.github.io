    ...
    <div>
        <table width="100%" border="0" cellspacing="1" cellpadding="2">
          ...
          <tr>
            ...
            <?php
            $angka=0; 
                $sql="select pd.pengeluaran_id,tanggal,nama_kas,keuangan_kas.jumlah,keuangan_peng_kategori.nama_kategori,sum(pd.jumlah) sum 
                    ...
                    inner join keuangan_pengeluaran_detail pd on(keuangan_pengeluaran.pengeluaran_id=pd.pengeluaran_id) 
                    where keuangan_kas.id_kas='$cboKas'
                    and tanggal<= '$tglTo'
                    and tanggal>='$tglFrom'
                    group by pd.pengeluaran_id ";
