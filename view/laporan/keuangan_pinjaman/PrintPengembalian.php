        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="2">
          ...
          <tr>
              <td width="100%" align="center"><font style="font-size: 18px;">
                  <b>Lapaoran Detail Pengeluaran</b>
            ...
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="2">              
                    <tr style="background: #CCC;">
                        ...
                        <td colspan="2" style="border: 1px solid black; border-left: none;">Detail</td>
                    </tr>
            <?php
            $angka=0; 
                $sql="select pengeluaran_id,tanggal,nama_kas,jumlah,keuangan_peng_kategori.nama_kategori 
                from keuangan_pengeluaran inner join keuangan_kas 
                on(keuangan_kas.id_kas=keuangan_pengeluaran.kas_id) 
                inner join keuangan_peng_kategori 
                on(keuangan_pengeluaran.kategori_id=keuangan_peng_kategori.id_kategori)
                ...
                while ($dataRow=  mysql_fetch_array($dataQry)){ 
                    ...
                    $sqlDtl="select kd.nama_pengeluaran, kd.jumlah 
                            from keuangan_pengeluaran_detail as kd 
                            where kd.pengeluaran_id='".$dataRow['pengeluaran_id']."';";
                    $dataD =  mysql_query($sqlDtl, DBConnection::getConnection())or die("Query error :".  mysql_error());
                    $num_rows = mysql_num_rows($dataD);
                    ?>
                    <tr>
                        <td rowspan="<?php echo $num_rows;?>" style="border: 1px solid black; border-top: none;"><?php echo $angka;?></td>
                        <td rowspan="<?php echo $num_rows;?>" style="border: 1px solid black; border-left: none; border-top: none;"><?php echo $dataRow['nama_kas'];?></td>
                        <td rowspan="<?php echo $num_rows;?>" style="border: 1px solid black; border-left: none; border-top: none;"><?php echo IndonesiaTgl($dataRow['tanggal']);?></td>
                        <td rowspan="<?php echo $num_rows;?>" style="border: 1px solid black; border-left: none; border-top: none;"><?php echo $dataRow['nama_kategori'];?></td> 
                
                    
               <?php
                
                while ($dataDtl=  mysql_fetch_array($dataD)){
                    $total=$total+$dataDtl['jumlah'];
                    ?>
                        <td width="19%" style="border: 1px solid black; border-left: none; border-top: none;"><?php echo $dataDtl['nama_pengeluaran'];?></td>
                      <td width="12%" style="border: 1px solid black; border-left: none; border-top: none;"><div align="right">Rp <?php echo number_format($dataDtl['jumlah']);?></div></td>
                    </tr>
                <?php
                    }
                }
             ?>
                    <tr>
                        <td  colspan="5" style="border: 1px solid black; border-top: none;"><div align="right"><strong>Jumlah Pemasukan</strong></div></td>
