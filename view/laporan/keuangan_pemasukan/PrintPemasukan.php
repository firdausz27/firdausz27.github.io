    ...
    <div>
        <table width="100%" border="0" cellspacing="1" cellpadding="2">
          ...
          <tr>
            ...
            <?php
            $angka=0; 
                $sql="select pemasukan_id,tanggal,nama_kas,jumlah,keuangan_kategori.nama_kategori 
                    ...
                    on(keuangan_pemasukan.kategori_id=keuangan_kategori.id_kategori) 
                ...
                while ($dataRow=  mysql_fetch_array($dataQry)){ 
                    ...
                    $sqlDtl="select p.nama_awal,p.nama_tengah,p.nama_akhir, kd.jumlah 
                    from keuangan_pemasukan_detail as kd inner join personal as p 
                    on(kd.personal_id=p.id_siswa)
                    where kd.pemasukan_id='".$dataRow['pemasukan_id']."';";
               ...
               <?php
                ...
                while ($dataDtl=  mysql_fetch_array($dataD)){
                    ...
                    ?>
                        <td width="19%" style="border: 1px solid black; border-left: none; border-top: none;"><?php echo $dataDtl['nama_awal'].' '.$dataDtl['nama_tengah'].' '.$dataDtl['nama_akhir'];?></td>
