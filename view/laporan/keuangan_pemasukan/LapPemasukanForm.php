    ...
    function validasi(){
        ...
        if(txtTglFrom==''){
           ...
           var w=950;
            ...
            if(pilihan==1){
                document.forms["form1"].action="./view/laporan/keuangan_pemasukan/PrintPemasukan.php"
                DoSubmit=window.open('about:blank','DoSubmit','scrollbars=1,status=1, width='+w+', height='+h+', top='+top+', left='+left)
                return true;
            }else if(pilihan==2){
                document.forms["form1"].action="./view/laporan/keuangan_pemasukan/PrintPemasukanResume.php"
                DoSubmit=window.open('about:blank','DoSubmit','scrollbars=1,status=1, width='+w+', height='+h+', top='+top+', left='+left)
                return true;
            }
        }
...
<form id="form1" name="form1" method="post">
    ...
    <tr>
        <tr>
           <td colspan="1" align="left" style="background: url(./images/headercontent2.jpg); font-size: 13px; color: #fff;"><!--<img src="./images/form_add.png">-->&nbsp;<b>Laporan | Pemasukan</b></td>
        </tr>
        <td>
