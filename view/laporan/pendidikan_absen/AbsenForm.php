...
<script type="text/javascript">
    ...
    function valid(){
            ...
            var cboList=document.getElementById("second").value;
           ...
           if(txtTanggalAwal==""){
                ...
                document.forms["form1"].action="./view/laporan/pendidikan_absen/LapAbsen.php"
   ...
   function kirim(){
            document.forms["form1"].action="?page=AbsenForm";
...
&nbsp;&nbsp;format tanggal ( mm/dd/YYY ) </td>
    ...
    <tr>
        <td width="27">&nbsp;</td>
        <td colspan="3">List Santri <font color="red">*</font></td>
    </tr>
   <tr>
        <td>&nbsp;</td>
        <td colspan="3">
