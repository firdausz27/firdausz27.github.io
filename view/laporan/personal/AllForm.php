...
<script type="text/javascript">
    ...
    function kirim(){
        document.forms["fAll"].method="post";
        document.forms["fAll"].action="?page=AllForm";
    ...
    function validasi(){
        ...
        if(cboJadual==''){
            ...
            //document.forms["fAllKirim"].method="post"
            document.forms["fAllKirim"].target="DoSubmit"
            if(pilihan==1){
                document.forms["fAllKirim"].action="./view/laporan/personal/AllPersonal.php"
                DoSubmit=window.open('about:blank','DoSubmit','scrollbars=1,status=1,resizable=1, width='+w+', height='+h+', top='+top+', left='+left)
                return true;
            }else if(pilihan==2){
                document.forms["fAllKirim"].action="./view/laporan/personal/AllPersonalData.php"
                DoSubmit=window.open('about:blank','DoSubmit','scrollbars=1,status=1,resizable=1, width='+w+', height='+h+', top='+top+', left='+left)
                return true;
            }else if(pilihan==3){
                document.forms["fAllKirim"].action="./view/laporan/personal/AllPersonalGrid.php"
                DoSubmit=window.open('about:blank','DoSubmit','scrollbars=1,status=1,resizable=1, width='+w+', height='+h+', top='+top+', left='+left)
                return true;
            }
...
<body>
    ...
    <tr>
        <tr>
           <td colspan="1" align="left" style="background: url(./images/headercontent2.jpg); font-size: 13px; color: #fff;"><!--<img src="./images/form_add.png">-->&nbsp;<b>Laporan | Data Personal</b></td>
        </tr>
        <td>
            <form id="fAll" name="fAll" >
            ...
            <form id="fAllKirim" name="fAllKirim" method="post" target="" >
                     <table width="100%" border="0" cellspacing="1" cellpadding="5" >
                         <tr>
                            <td width="25">&nbsp;</td>
                            <td >
                                <input type="radio" name="typeReport" id="typeReport" value="1" checked=""/> Resume
                                <input type="radio" name="typeReport" id="typeReport" value="2" /> Personal Detail
                                <input type="radio" name="typeReport" id="typeReport" value="3" /> grid
                            </td>
                        </tr>
                         <tr>
                             <td width="27">&nbsp;</td>
                    ...
                    <tr>
                        <td colspan="2" align="center"><input type="submit" name="bEdit" value="Print" onClick="validasi();" />
