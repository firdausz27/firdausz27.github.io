...
$tampil0 = $fileDao->getTampil($kode);
...
?>
<form id="form1" name="form1" method="post" action="?page=updateFile">
  <table width="750" border="0" cellspacing="1" cellpadding="2">
    ...
    <tr>
      ...
      <td>Kode</td>
      <td>:</td>
      <td><input type="text" name="txtKide" id="txtKide" value="<?php echo $tampil0->getKode();?>"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>URL</td>
      <td>:</td>
      <td><input name="txtUrl" type="text" id="txtUrl" size="50" maxlength="500" value="<?php echo $tampil0->getUrl();?>"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>Nama Form</td>
      <td>:</td>
      <td><input name="txtNamaForm" type="text" id="txtNamaForm" size="30" maxlength="100" value="<?php echo $tampil0->getNamaForm();?>"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>Digunakan Di Menu</td>
      <td>:</td>
      <td><input name="txtMenu" type="text" id="txtMenu" size="50" maxlength="100" value="<?php echo $tampil0->getMenu();?>"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>Modul</td>
      <td>:</td>
      <td><input name="txtModul" type="text" id="txtModul" size="50" maxlength="100" value="<?php echo $tampil0->getModul();?>"/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
