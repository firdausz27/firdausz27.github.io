        ...
        <script>          
            function validasi(mode){
                ...
                if(txtName==""){
                    ...
                    if(mode=='update'){
                        document.forms["fGroup"].action="?page=GroupAction&action=update";
                        document.forms["fGroup"].submit();
                        return true;
                    }else{
                        if(confirm('Apakah anda yakin mau menghapus ?')){
                            document.forms["fGroup"].action="?page=GroupAction&action=delete";
                            document.forms["fGroup"].submit();
                            return true;
                        }
                    }
            ...
            function geroupData(){
                document.forms["fGroup"].action="?page=addMenu";
                document.forms["fGroup"].submit();
                return true;
            }
            
             function geroupEmp(){
                document.forms["fGroup"].action="?page=addPersonal";
                document.forms["fGroup"].submit();
                return true;
            }
        </script>
    ...
    <body style="margin-left: 0px; margin-top: 0px;">
        ...
        <table width="100%" border="0" cellspacing="3" cellpadding="3" class="table-shadow" >    
            ...
            <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><input type="button" value="Group User" name="bGroupUser" onclick="geroupEmp();"/>
                    <input type="button" value="Group Menu" name="bGroupData" onclick="geroupData();"/>
